    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f5f6fa] p-4 font-sans">
      ...
      <div className="bg-white w-full max-w-[450px] p-10 rounded-2xl shadow-sm border border-gray-100">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-2xl font-bold text-[#2c3e50] mb-1">
            Smart Restaurant
          </h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="flex justify-between items-center pt-2">
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                type="checkbox"
                className="w-4 h-4 rounded text-[#e74c3c] focus:ring-[#e74c3c] border-gray-300"
              />
              <span className="text-sm text-[#7f8c8d]">Remember me</span>
            </label>
            <a
              href="#"
              className="text-sm text-[#e74c3c] hover:underline font-medium"
            >
              Forgot Password?
            </a>
          </div>
